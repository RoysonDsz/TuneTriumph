...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add event listeners for home and playlist buttons
    document.getElementById('home-button').addEventListener('click', showHome);
    document.getElementById('playlist-button').addEventListener('click', showPlaylist);
...
// Ensure grid-container class is used for grid layouts
document.getElementById('results').classList.add('grid-container');
document.getElementById('playlist').classList.add('grid-container');
...
function showHome() {
    ...
    // Apply the grid layout to results
    document.getElementById('results').classList.add('grid-container');
}
...
function showPlaylist() {
    ...
    // Apply the grid layout to playlist
    document.getElementById('playlist').classList.add('grid-container');
}
